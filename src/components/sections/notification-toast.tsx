...
const claimsData = [
  { name: "Michael T.", amount: "$500" },
  { name: "Emily R.", amount: "$500" },
  { name: "David S.", amount: "$500" },
  { name: "Sarah J.", amount: "$500" },
  { name: "James L.", amount: "$500" },
  { name: "Jessica W.", amount: "$500" },
  { name: "Brandon K.", amount: "$500" },
  { name: "Amanda H.", amount: "$500" },
  { name: "Tyler M.", amount: "$500" },
  { name: "Rachel P.", amount: "$500" },
  { name: "Kevin D.", amount: "$500" },
  { name: "Lauren B.", amount: "$500" },
  { name: "Chris N.", amount: "$500" },
  { name: "Ashley G.", amount: "$500" },
  { name: "Ryan F.", amount: "$500" },
  { name: "Megan C.", amount: "$500" },
  { name: "Daniel V.", amount: "$500" },
  { name: "Stephanie A.", amount: "$500" },
  { name: "Andrew Z.", amount: "$500" },
  { name: "Nicole E.", amount: "$500" },
];
